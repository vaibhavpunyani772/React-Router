  ...
  return (
    <div className="mx-auto w-full max-w-7xl">
      <aside className="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
        ...
        <div className="w-full sm:my-20 sm:pt-1  ">
          <img
            className=" absolute w-120 h-90 rounded-3xl overflow-hidden top-10 mt-20 "
      ...
      <div className="grid  place-items-center sm:mt-20">
        <img
          className="sm:w-120 w-60 rounded-3xl shadow-sm overflow-hidden "
